...
INSERT INTO local_profile_v6 SELECT * FROM local_profile;
DROP TABLE local_profile;
ALTER TABLE local_profile_v6 RENAME TO local_profile;

CREATE TABLE peers_v6 (
...
INSERT INTO peers_v6 SELECT * FROM peers;
DROP TABLE peers;
ALTER TABLE peers_v6 RENAME TO peers;
